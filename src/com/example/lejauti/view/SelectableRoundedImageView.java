package com.example.lejauti.view;
...
public class SelectableRoundedImageView extends ImageView {
	...
	private float mLeftTopCornerRadius = 10f;
	private float mRightTopCornerRadius = 10f;
	...
	public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mRadii = new float[] { mLeftTopCornerRadius, mLeftTopCornerRadius, mRightTopCornerRadius, mRightTopCornerRadius,
				mRightBottomCornerRadius, mRightBottomCornerRadius, mLeftBottomCornerRadius, mLeftBottomCornerRadius };
	...
	static class SelectableRoundedCornerDrawable extends Drawable {
		...
		private void adjustCanvasForBorder(Canvas canvas) {
			...
			if (ScaleType.FIT_START == mScaleType || ScaleType.FIT_END == mScaleType || ScaleType.FIT_XY == mScaleType
					|| ScaleType.FIT_CENTER == mScaleType || ScaleType.CENTER_INSIDE == mScaleType
